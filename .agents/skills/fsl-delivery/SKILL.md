...
The canonical upstream skill is [`skills/fsl-delivery/SKILL.md`](../../../skills/fsl-delivery/SKILL.md).

Before taking task actions, read the canonical `SKILL.md` completely and follow it.
Treat `skills/fsl-delivery/` as the skill directory when resolving relative
