...
| H-022 | ライフサイクル | 高速再読込、タブ休止、戻る進む、更新配信、古いキャッシュを確認する | G-015, G-018, G-022, G-031 | 必須 |
| H-023 | Experimental / Limited | 対象の公式対応環境で最小試作と本番配信の両方を確認する | G-016, G-020, G-023, G-024, G-025, G-026, G-027, G-028, G-031 | 条件付き必須 |
