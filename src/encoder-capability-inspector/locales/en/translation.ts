...
const translation: TranslationResource = {
  ...
  progress: {
    ...
    familyNote:
      "Video is counted per codec string; audio is counted per Profile and channel configuration. Only fully completed inspections are counted.",
  ...
  table: {
    ...
    knownDiscreteBitrates: "Known discrete values: {{values}} ({{source}})",
    knownDiscreteBitratesShort: "Known: {{values}}",
    bitrateSource: {
      "chromium-windows-mf-aac": "Windows Chromium AAC implementation",
    },
