...
const translation: TranslationResource = {
  ...
  progress: {
    ...
    familyNote:
      "Video is counted per codec string and bitrate mode; audio is counted per Profile, channel, and bitrate mode. Only fully completed inspections are counted.",
    environment: "Environment",
    cores: "{{count}} logical cores",
    stage: {
      declared: "Checking whether the config is accepted",
      configure: "Configuring the encoder",
      encode: "Encoding",
      flush: "Finishing encoder output",
  ...
  preview: {
    ...
    description:
      "Plays representative input generated by the same code as the inspection. The preview is {{width}}×{{height}}; the inspection draws the same pattern at each candidate's own resolution. Audio loops a {{seconds}} second stretch. AAC and Opus use different chunk lengths during inspection.",
  ...
  table: {
    ...
    columnBitrateMode: "Bitrate mode",
    ...
    columnTime: "Duration",
    probeBitrate: "Test: {{value}}",
    probeQuantizer: "Test QP: {{value}}",
    ...
    backendHint:
      "WebCodecs exposes no API for the implementation actually used. This is inferred by matching output byte and chunk counts against prefer-hardware and prefer-software for the same codec string and bitrate mode.",
  ...
  bitrateGuide: {
    ...
    description:
      "Support values and recommendations confirmed by codec specifications, official implementations, and publishing guides. Use the inspection result to confirm what this browser actually accepts and outputs.",
    summary: "Showing {{shown}} of {{total}} entries",
    tableLabel: "Bitrate guide entries",
    noMatch: "No guide entries match the current filters",
    filterAll: "All",
    filterCodecPlaceholder: "Search codec string",
    sortHint: "Click to cycle ascending, descending, and cleared",
    infoButton: "Show bitrate and quantizer information for {{codec}}",
    dialogTitle: "Bitrate and quantizer information for {{codec}}",
    profileLevel: "Profile / Level",
    supportHeading: "Support values (specification / implementation)",
    recommendationHeading: "Recommendations and targets",
    quantizerHeading: "Quantizer parameter",
    quantizerSupportHeading: "Supported range",
    quantizerRecommendationHeading: "Recommendation / target",
    testValue: "This inspection bitrate: {{value}}",
    testQuantizer: "This inspection quantizer: {{value}}",
    rangeUpTo: "up to {{max}}",
    rangeBetween: "{{min}}–{{max}}",
    rangeFrom: "{{min}} and above",
    discrete: "{{values}} (discrete values)",
    dynamicSupport:
      "The implementation chooses applicable values from the current sample-rate/channel settings (no fixed list).",
    quantizerRangeUpTo: "up to {{max}}",
    quantizerRangeBetween: "{{min}}–{{max}}",
    quantizerRangeFrom: "{{min}} and above",
    quantizerDiscrete: "{{values}} (discrete values)",
    quantizerTarget: "{{value}} (target)",
    quantizerLowerIsHigherQuality:
      "Lower values mean higher quality; higher values mean lower quality (stronger compression).",
    quantizerNotApplicable:
      "This codec has no WebCodecs codec-specific quantizer option.",
    quantizerComparisonValue: "Inspector comparison value: {{value}}",
    unbounded: "No general upper limit",
    noPublishedValue: "No single published value",
    noUniversalValue: "No universal profile recommendation",
    noUniversalQuantizer:
      "No universal official recommendation for H.264/HEVC/AV1",
    vp8NoQuantizer:
      "The WebCodecs registration defines no codec-specific quantizer option.",
    authorityStandard: "Specification",
    authorityImplementation: "Official implementation",
    authorityRecommendation: "Recommendation guide",
    authorityComparison: "Comparison baseline",
    context: {
      windowsChromium: "Windows Chromium Media Foundation AAC",
      macChromium: "macOS Chromium AudioToolbox (configuration-dependent)",
      macSafari: "macOS Safari AudioToolbox (configuration-dependent)",
      comparison: "Inspector comparison target (AV1)",
      noUniversalValue: "AAC varies by use case and implementation",
      noUniversalQuantizer:
        "No universal official recommendation for H.264/HEVC/AV1",
      vp8NoQuantizer: "VP8 has no codec-specific quantizer option",
      vp9GoodQuality: "Google guide's good-quality target",
      hevcMainTier: "HEVC Main tier",
      av1MainTier: "AV1 Main tier",
      av1HighTier: "AV1 High tier",
      opusNbSpeech: "Opus narrowband speech",
      opusWbSpeech: "Opus wideband speech",
      opusFbSpeech: "Opus fullband speech",
      opusMonoMusic: "Opus fullband mono music",
      opusStereoMusic: "Opus fullband stereo music",
    },
    close: "Close",
  },
  references: {
  ...
  codes: {
    ...
    "aac-output-profile-mismatch":
      "The actual AAC output profile differs from the requested profile",
