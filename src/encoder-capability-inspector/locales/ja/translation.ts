...
const translation: TranslationResource = {
  ...
  progress: {
    ...
    familyNote:
      "映像は codec string × bitrateMode、音声は Profile・チャンネル数・bitrateMode まで含んだ設定の数を分母にします。完全に完了した検査の結果だけを集計します。",
    environment: "実行環境",
    cores: "{{count}} 論理コア",
    stage: {
      declared: "設定の受理を確認中",
  ...
  table: {
    ...
    budgetUnder: "100% 以下",
    backendHint:
      "WebCodecs には実際に使われた実装を返す API がありません。同じ codec string × bitrateMode の prefer-hardware / prefer-software と出力バイト数・チャンク数を突き合わせた推定です。",
  ...
  bitrateGuide: {
    heading: "ビットレートガイド",
    description:
      "仕様・公式実装・公式配信ガイドで確認できるサポート値と推奨値です。ブラウザーが実際に受理・出力できるかは、検査結果で確認してください。",
    summary: "{{shown}} / {{total}} 件を表示",
    tableLabel: "ビットレートガイド一覧",
    noMatch: "条件に一致するガイド項目がありません",
    filterAll: "すべて",
    filterCodecPlaceholder: "codec stringを検索",
    sortHint: "クリックで昇順・降順・解除を切り替え",
    infoButton: "{{codec}} のビットレート・量子化情報を表示",
    dialogTitle: "{{codec}} のビットレート・量子化情報",
    profileLevel: "Profile / Level",
    supportHeading: "サポート値（仕様・実装）",
    recommendationHeading: "推奨・目安",
    quantizerHeading: "量子化パラメーター",
    quantizerSupportHeading: "サポート範囲",
    quantizerRecommendationHeading: "推奨・目安",
    testValue: "この検査のビットレート: {{value}}",
    testQuantizer: "この検査の量子化パラメーター: {{value}}",
    rangeUpTo: "{{max}} 以下",
    rangeBetween: "{{min}}〜{{max}}",
    rangeFrom: "{{min}} 以上",
    discrete: "{{values}}（離散値）",
    dynamicSupport:
      "現在のサンプルレート・チャンネル設定に応じて実装が適用値を決定（固定一覧なし）",
    quantizerRangeUpTo: "{{max}} 以下",
    quantizerRangeBetween: "{{min}}〜{{max}}",
    quantizerRangeFrom: "{{min}} 以上",
    quantizerDiscrete: "{{values}}（離散値）",
    quantizerTarget: "{{value}}（目安）",
    quantizerLowerIsHigherQuality:
      "値が小さいほど高品質・大きいほど低品質です（圧縮が強くなります）",
    quantizerNotApplicable:
      "このコーデックにはWebCodecsの量子化オプションがありません",
    quantizerComparisonValue: "この検査の比較値: {{value}}",
    unbounded: "一般的な上限なし",
    noPublishedValue: "公開された一律の値なし",
    noUniversalValue: "プロファイル共通の公式推奨値なし",
    noUniversalQuantizer: "H.264/HEVC/AV1は一律の公式推奨値なし",
    vp8NoQuantizer: "WebCodecs登録仕様にcodec-specificな量子化オプションなし",
    authorityStandard: "仕様",
    authorityImplementation: "公式実装",
    authorityRecommendation: "推奨ガイド",
    authorityComparison: "比較用目安",
    context: {
      windowsChromium: "Windows Chromium の Media Foundation AAC",
      macChromium: "macOS Chromium の AudioToolbox（設定依存）",
      macSafari: "macOS Safari の AudioToolbox（設定依存）",
      comparison: "この検査の比較用目標（AV1）",
      noUniversalValue: "AAC は用途・実装によって適切な値が変わります",
      noUniversalQuantizer: "H.264/HEVC/AV1は一律の公式推奨値なし",
      vp8NoQuantizer: "VP8はcodec-specific量子化オプションなし",
      vp9GoodQuality: "Googleガイドの良好な品質目安",
      hevcMainTier: "HEVC Main tier",
      av1MainTier: "AV1 Main tier",
      av1HighTier: "AV1 High tier",
      opusNbSpeech: "Opus narrowband 音声",
      opusWbSpeech: "Opus wideband 音声",
      opusFbSpeech: "Opus fullband 音声",
      opusMonoMusic: "Opus fullband モノラル音楽",
      opusStereoMusic: "Opus fullband ステレオ音楽",
    },
    close: "閉じる",
  },
  references: {
