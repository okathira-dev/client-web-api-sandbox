...
- [../domain/plan.test.ts](../domain/plan.test.ts): 候補行列の件数・bitrate mode・ID の一意性・codec string の形式
...
- [../features/BitrateGuide/filters.test.ts](../features/BitrateGuide/filters.test.ts): ビットレートガイドの絞り込み・並べ替え
...
- [@tanstack/react-virtual](https://tanstack.com/virtual) (MIT): 結果一覧・ビットレートガイドの仮想化
