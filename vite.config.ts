    ...
    rollupOptions: {
      input: {
        ...
        "webcodecs-data-moshing": resolve(
          root,
          "webcodecs-data-moshing/index.html",
        ),
        "webcodecs-data-moshing-react": resolve(
          root,
          "webcodecs-data-moshing-react/index.html",
        ),
        "button-accordion-with-keyboard": resolve(
          root,
          "button-accordion-with-keyboard/index.html",
        ),
        "lcg-predictor": resolve(root, "lcg-predictor/index.html"),
        "projectile-director": resolve(root, "projectile-director/index.html"),
      },
    },
  },
});
